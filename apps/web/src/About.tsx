  ...
  return (
    <article>
      ...
      <p>
        ...
        tired of manually checking a dozen different careers portals for openings. Paddock Jobs
        pulls every open role across motorsport teams into one feed, normalizes it, and can email
        you the moment something new matches what you&apos;re looking for. Formula 1 is fully
        covered today; WEC/IMSA endurance racing is next.
      </p>
      <p>
